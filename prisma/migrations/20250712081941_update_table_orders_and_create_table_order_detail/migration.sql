/*
  ...
  - Added the required column `payment_Ref` to the `orders` table without a default value. This is not possible if the table is not empty.
  - Added the required column `reciverAddress` to the `orders` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `orders` ADD COLUMN `paymentMethod` VARCHAR(191) NOT NULL,
    ...
    ADD COLUMN `reciverAddress` VARCHAR(255) NOT NULL,
